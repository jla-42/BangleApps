...
const clock = new ClockFace({
  ...
  draw: function (date) {
    ...
    g.drawString(temp + " °C", this.centerDatesScaleX, this.center.y + 10 * this.scale); //48
    g.drawString(condition(curr.txt), this.centerDatesScaleX, this.center.y + 24 * this.scale);
